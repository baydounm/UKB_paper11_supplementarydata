...
cd "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA"

capture log close
log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\DATA_MANAGEMENT.smcl",replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\SMALLERDATASETUKB_FIRST100K.dta", replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\SMALLERDATASETUKB_SECOND100K.dta", replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\SMALLERDATASETUKB_THIRD100K.dta", replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\SMALLERDATASETUKB_FOURTH100K.dta", replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\SMALLERDATASETUKB_FIFTH100K.dta", replace
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\DATA_MANAGEMENT2.smcl",replace

************************************************************************************************************************

**Format time-series variables using the do file**

use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\SMALLERDATASETUKBfin.dta",clear
sort n_eid
capture drop _merge
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\SMALLERDATASETUKBfinalized.dta", replace


**************************DEMOGRAPHICS, SES: Fix this section in all papers*********************************************
cd "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA"

use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\SMALLERDATASETUKBfinalized", clear
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\DEMOG_SES_UKB", replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\LIFESTYLENODIET_UKB",replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\LIFESTYLEDIET_UKB",replace
...
use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\SMALLERDATASETUKBfin", clear

keep n_eid n_30890_0_0 n_30070_0_0

save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\NUTR_UKB",replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\SS_UKB",replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\HEALTH_UKB",replace
...
use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\DEMOG_SES_UKB",clear
sort n_eid
capture drop _merge
save, replace

use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\LIFESTYLENODIET_UKB",clear
sort n_eid
capture drop _merge
save, replace


use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\LIFESTYLEDIET_UKB",clear
sort n_eid
capture drop _merge
save, replace


use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\SS_UKB",clear
sort n_eid
capture drop _merge
save, replace

use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\HEALTH_UKB",clear
sort n_eid
capture drop _merge
save, replace


use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\NUTR_UKB",clear
sort n_eid
capture drop _merge
save, replace
...
use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\DEMOG_SES_UKB",clear
merge n_eid using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\LIFESTYLENODIET_UKB"
sort n_eid
capture drop _merge
merge n_eid using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\LIFESTYLEDIET_UKB"
sort n_eid
capture drop _merge
merge n_eid using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\SS_UKB"
sort n_eid
capture drop _merge
merge n_eid using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\HEALTH_UKB"
sort n_eid
capture drop _merge
merge n_eid using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\NUTR_UKB"
sort n_eid
capture drop _merge

save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\LE8_UKB", replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\MEDICATIONS_UKB", replace
...
use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\LE8_UKB",clear
sort n_eid
capture drop _merge
save, replace


use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\MEDICATIONS_UKB",clear
sort n_eid
capture drop _merge
save, replace

use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\LE8_UKB",clear
merge n_eid using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\MEDICATIONS_UKB"
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\LE8_UKB", replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\COGN_UKB",replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\ADDEMENTIA_UKB",replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\UKB_PGS", replace
...
use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\ADDEMENTIA_UKB",clear
sort n_eid
capture drop _merge
save, replace

use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\COGN_UKB",clear
sort n_eid
capture drop _merge
save, replace
...
merge n_eid using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\COGN_UKB"
capture drop _merge
sort n_eid
merge n_eid using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\ADDEMENTIA_UKB"
capture drop _merge
sort n_eid
merge n_eid using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\UKB_PGS"

save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\UKB_PAPER8D_LE8PROTDEM", replace


capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\DATA_MANAGEMENT3.smcl",replace
...
use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\UKB_PAPER8D_LE8PROTDEM",clear
sort n_eid
capture drop _merge
save, replace

use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\proteomic_olink_instance0fin",clear
sort n_eid
capture drop _merge
save, replace

use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\withdrawals",clear
sort n_eid
capture drop _merge
save, replace
...
gen sample3=.
replace sample3=1 if baselineage>=50 & baselineage~=. & LE8_TOTALSCORE~=. & LE8_LIFESTYLE~=. & LE8_BIOLOGICAL~=. & LE8_COMP1DIET~=. & LE8_COMP2PA~=. & LE8_COMP3NICOTINE~=. & LE8_COMP4SLEEP~=. & LE8_COMP5BMI~=. & LE8_COMP6LIPIDS~=. & LE8_COMP7GLUC~=. & LE8_COMP8BP~=. & householdsize~=. &SES~=. & ethnicity2~=. & AD_PGS~=. ~=. & sample2==1
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\IMPUTATIONS.smcl",replace
...
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\TABLE1.smcl",replace

use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\finaldata_unimputedfin",clear
...
foreach x2 of varlist dem_diag ad_diag SEX RACE_ETHN NonWhite educationbr householdincome   AD_PGStert {
...
foreach x2 of varlist dem_diag ad_diag  RACE_ETHN NonWhite educationbr householdincome  AD_PGStert {
...
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\FIGURE1.smcl",replace
...
sts graph if sample_final==1 & _t<84, gwood legend(on) xlabel(65(5)90) ylabel(0.50(.10)1) xtitle("Age at diagnosis") ytitle("KM Estimated Proportion Dementia-Free (95%CI)") title("LE8 tertile vs. dementia,total sample") by (LE8_TOTALSCOREtertinv) tmin(65) tmax(90) 
...
sts graph if sample_final==1 & _t<84, gwood legend(on) xlabel(65(5)90) ylabel(0.50(.10)1) xtitle("Age at diagnosis") ytitle("KM Estimated Proportion Dementia-Free (95%CI)") title("LE8 tertile vs. dementia,total sample") by (LE8_TOTALSCOREtertinv) tmin(65) tmax(90) risktable
...
sts graph if sample_final==1 & _t<84 & SEX==1, gwood legend(on) xlabel(65(5)90) ylabel(0.50(.10)1) xtitle("Age at diagnosis") ytitle("KM Estimated Proportion Dementia-Free (95%CI)") title("LE8 tertile vs. dementia, Men") by (LE8_TOTALSCOREtertinv) tmin(65) tmax(90) 
graph save "FIGURE1B.gph", replace
sts test LE8_TOTALSCOREtert if sample_final==1 & _t<84 & SEX==1
stcox i.LE8_TOTALSCOREtert if sample_final==1 & _t<84 & SEX==1
...
sts graph if sample_final==1 & _t<84 & SEX==2, gwood legend(on) xlabel(65(5)90) ylabel(0.50(.10)1) xtitle("Age at diagnosis") ytitle("KM Estimated Proportion Dementia-Free (95%CI)") title("LE8 tertile vs. dementia, Women") by (LE8_TOTALSCOREtertinv) tmin(65) tmax(90) 
graph save "FIGURE1C.gph", replace
sts test LE8_TOTALSCOREtert if sample_final==1 & _t<84 & SEX==2
stcox i.LE8_TOTALSCOREtert if sample_final==1 & _t<84 & SEX==2
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\TERTILE_DESC.smcl",replace
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\VOLCANO_PLOT.smcl",replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\finaldata_unimputedfin",replace
...
tempfile tf$modseq
parmby "regr `Y' zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta", label command format(estimate min95 max95 %8.2f p %8.1e) idn($modseq) saving(`tf$modseq',replace) flist(tflist)
}
dsconcat $tflist
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\TABLE2.smcl",replace
...
**Model 2: Interaction with AD PGS tertile**
 stcox c.zLE8_TOTALSCOREinv##c.AD_PGStert AGE SEX NonWhite householdsize SES  if sample_final==1

**Stratified analysis by AD PGS TERTILES**

**LOWEST TERTILE**

 stcox zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 & AD_PGStert==1

**MIDDLE TERTILE**

 stcox zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES  if sample_final==1 & AD_PGStert==2

**HIGHEST TERTILE**
 stcox zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES  if sample_final==1 & AD_PGStert==3
...
**Model 2: Interaction with AD PGS TERTILE **
 stcox c.zLE8_TOTALSCOREinv##c.AD_PGStert AGE SEX NonWhite householdsize SES  if SEX==1 & sample_final==1

**Stratif SEX==1 by AD PGS TERTILES**

**LOWEST TERTILE**

 stcox zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES  if SEX==1 & sample_final==1 & AD_PGStert==1

 **MIDDLE TERTILE**

 stcox zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES  if SEX==1 & sample_final==1 & AD_PGStert==2

**HIGHEST TERTILE**
 stcox zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if SEX==1 & sample_final==1 & AD_PGStert==3
...
**Model 2: Interaction with AD PGS TOTAL SCORE**
 stcox c.zLE8_TOTALSCOREinv##c.AD_PGStert AGE SEX NonWhite householdsize SES  if SEX==2 & sample_final==1

**Stratif SEX==2  by AD PGS TERTILES**

**LOWEST TERTILE**

 stcox zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES  if SEX==2 & sample_final==1 & AD_PGStert==1

**MIDDLE TERTILE**

 stcox zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES  if SEX==2 & sample_final==1 & AD_PGStert==2

**HIGHEST TERTILE**
 stcox zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES if SEX==2 & sample_final==1 & AD_PGStert==3
...
*****************************************************************************************************************************************************************************
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\FOURWAYDECOMP_SUPPLEMENT.smcl",replace
...
med4way zLE8_TOTALSCOREinv `m' AGE SEX NonWhite householdsize SES  if sample_final==1 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
}
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\FIGURE3_FOURWAYDECOMPABRIDGED_TOPPROTS.smcl",replace
...
**      |                                                                                           command |
**      |---------------------------------------------------------------------------------------------------|
**   1. |       regr zggh zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**   2. |      regr zvwa1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**   3. |     regr zil1rn zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**   4. |      regr zprcp zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**   5. |   regr zsiglec7 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**   6. |     regr zfgfr2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**   7. |      regr zhnmt zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**   8. |      regr zace2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**   9. |    regr zhavcr1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  10. |      regr zggt1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  11. |     regr zgolm2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  12. |       regr zlpl zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  13. |     regr zasgr1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  14. |     regr zfurin zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  15. |     regr zgsta1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  16. |      regr zplat zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  17. |      regr ztfpi zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  18. |     regr zerbb2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  19. |      regr zpon3 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  20. |    regr zlgals9 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  21. |   regr zst6gal1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  22. |    regr zigfbp2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  23. |    regr zigfbp1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  24. |      regr zagrn zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  25. |      regr zdcxr zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  26. |       regr zcpm zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  27. |     regr zfabp4 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  28. |       regr zlep zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  29. |     regr zcntn3 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  30. |     regr zccl22 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  31. |  regr ztnfrsf1a zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  32. |     regr zcdhr2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  33. |    regr zcd99l2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  34. |      regr zsele zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  35. |      regr zcdh2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  36. |     regr zgsta3 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  37. |     regr zitga5 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  38. |    regr zigfbp4 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  39. |      regr zsncg zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  40. |      regr zca14 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  41. |     regr zgdf15 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  42. |     regr zigsf3 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  43. |     regr zfstl3 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  44. |      regr zstc1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  45. |     regr zicam1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  46. |     regr zssc4d zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  47. |       regr zpts zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  48. |    regr zsema3f zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  49. |     regr zssc5d zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  50. |   regr zangptl2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  51. |      regr zacy1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  52. |        regr zf9 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  53. |   regr zrarres2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  54. |    regr zil18r1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  55. |     regr zfgf21 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  56. |     regr zrtn4r zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  57. |       regr zosm zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  58. |     regr zlamp2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  59. |    regr zcol6a3 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  60. |  regr zc19orf12 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  61. |    regr zlilra5 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  62. |  regr zadamts15 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  63. |       regr zezr zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  64. |      regr zpigr zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  65. |       regr zadm zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  66. |      regr zldlr zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  67. |     regr zsfrp1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  68. |      regr zcst3 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  69. |       regr zhgf zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  70. |      regr zgusb zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  71. |     regr zinhbc zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  72. |   regr zwfikkn2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  73. |     regr zccl16 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  74. |        regr zf7 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  75. |      regr zces1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  76. |       regr zoxt zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 77. |    regr zbaiap2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  78. |   regr zcolec12 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  79. |     regr zpamr1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  80. |    regr zcxcl17 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  81. |       regr zil6 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  82. |     regr zkrt18 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  83. |      regr zclmp zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  84. |      regr zsord zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  85. |     regr zplaur zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  86. |    regr zlgals1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  87. |     regr zsmad5 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  88. |      regr zscly zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  89. |      regr zces2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  90. |      regr zrbp5 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**     |---------------------------------------------------------------------------------------------------|
***  91. |      regr zadh4 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  92. |    regr zacvrl1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  93. |     regr zprss8 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  94. |      regr zkynu zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  95. |     regr zcrip2 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
**  96. |      regr zctsd zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  97. |     regr znomo1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  98. |      regr zctso zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**  99. |     regr zgfra1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 100. |     regr zmfap5 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
** 101. |     regr zcrhbp zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 102. |      regr zambp zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 103. |     regr zcreg1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 104. |  regr ztnfrsf6b zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 105. |      regr zp4hb zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
** 106. |   regr zil13ra1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 107. |      regr ztgfa zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 108. |   regr zpla2g15 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 109. |     regr zmegf9 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 110. |      regr zil16 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
** 111. |   regr zcol18a1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 112. |     regr zfabp1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 113. |   regr zaldh1a1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 114. |     regr zplin1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 115. |   regr zpla2g10 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
** 116. |      regr zesm1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 117. |      regr ztpp1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 118. |   regr zslc39a5 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 119. |      regr znos3 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 121. |   regr zsult2a1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
** 122. |      regr zalpp zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 123. |     regr zmfge8 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 124. | regr ztnfrsf10a zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 125. |       regr znpy zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 126. |     regr zsmoc1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
** 127. |       regr zmme zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 128. |      regr zca5a zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 129. |     regr zigf2r zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 130. |     regr zefna4 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 131. |       regr zmvk zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
** 132. |       regr zcd4 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 133. |    regr zil10rb zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 134. |      regr zpltp zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 135. |     regr zdpy30 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 136. |      regr zcstb zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
** 137. |      regr zproc zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 138. |     regr ztimp1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 139. |     regr zcdhr5 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 140. |     regr zpcsk9 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 142. |      regr zhao1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      |---------------------------------------------------------------------------------------------------|
** 144. |      regr zlsp1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 145. |    regr zifnlr1 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 146. |      regr zccl7 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
** 147. |     regr zigsf8 zLE8_TOTALSCOREinv AGE SEX NonWhite householdsize SES   if sample_final==1 , beta |
**      +---------------------------------------------------------------------------------------------------+

 **zggh  zvwa1  zil1rn  zprcp  zsiglec7  zfgfr2  zhnmt  zace2  zhavcr1  zggt1  zgolm2  zlpl  zasgr1  zfurin  zgsta1  zplat  ztfpi  zerbb2  zpon3  zlgals9 ///
 **zst6gal1  zigfbp2  zigfbp1  zagrn  zdcxr  zcpm  zfabp4  zlep  zcntn3  zccl22  ztnfrsf1a  zcdhr2  zcd99l2  zsele  zcdh2  zgsta3  zitga5  zigfbp4  zsncg ///
 **zca14  zgdf15  zigsf3  zfstl3  zstc1  zicam1  zssc4d  zpts  zsema3f  zssc5d  zangptl2  zacy1  zf9  zrarres2  zil18r1  zfgf21  zrtn4r  zosm  zlamp2  zcol6a3 ///
 **zc19orf12  zlilra5  zadamts15  zezr  zpigr  zadm  zldlr  zsfrp1  zcst3  zhgf  zgusb  zinhbc  zwfikkn2  zccl16  zf7  zces1  zoxt  zbaiap2  zcolec12  zpamr1 ///
 **zcxcl17  zil6  zkrt18 zclmp  zsord  zplaur  zlgals1 zsmad5  zscly  zces2  zrbp5  zadh4  zacvrl1  zprss8  zkynu  zcrip2  zctsd  znomo1  zctso  zgfra1  zmfap5 ////
 **zcrhbp  zambp  zcreg1  ztnfrsf6b  zp4hb  zil13ra1  ztgfa  zpla2g15  zmegf9  zil16  zcol18a1  zfabp1  zaldh1a1  zplin1  zpla2g10  zesm1  ztpp1  zslc39a5  znos3 ////
 **zsult2a1 zalpp zmfge8 ztnfrsf10a znpy zsmoc1 zmme zca5a zigf2r zefna4 zmvk zcd4 zil10rb zpltp zdpy30 zcstb zproc ztimp1 zcdhr5 zpcsk9 zhao1 zlsp1 zifnlr1 zccl7 zigsf8 ///



foreach m of varlist zggh  zvwa1  zil1rn  zprcp  zsiglec7  zfgfr2  zhnmt  zace2  zhavcr1  zggt1  zgolm2  zlpl  zasgr1  zfurin  zgsta1  zplat  ztfpi  zerbb2  zpon3  zlgals9  zst6gal1  zigfbp2  zigfbp1  zagrn  zdcxr  zcpm  zfabp4  zlep  zcntn3  zccl22  ztnfrsf1a  zcdhr2  zcd99l2  zsele  zcdh2  zgsta3  zitga5  zigfbp4  zsncg  zca14  zgdf15  zigsf3  zfstl3  zstc1  zicam1  zssc4d  zpts  zsema3f  zssc5d  zangptl2  zacy1  zf9  zrarres2  zil18r1  zfgf21  zrtn4r  zosm  zlamp2  zcol6a3  zc19orf12  zlilra5  zadamts15  zezr  zpigr  zadm  zldlr  zsfrp1  zcst3  zhgf  zgusb  zinhbc  zwfikkn2  zccl16  zf7  zces1  zoxt  zbaiap2  zcolec12  zpamr1  zcxcl17  zil6  zkrt18 zclmp  zsord  zplaur  zlgals1 zsmad5  zscly  zces2  zrbp5  zadh4  zacvrl1  zprss8  zkynu  zcrip2  zctsd  znomo1  zctso  zgfra1  zmfap5  zcrhbp  zambp  zcreg1  ztnfrsf6b  zp4hb  zil13ra1  ztgfa  zpla2g15  zmegf9  zil16  zcol18a1  zfabp1  zaldh1a1  zplin1  zpla2g10  zesm1  ztpp1  zslc39a5  znos3   zsult2a1 zalpp zmfge8 ztnfrsf10a znpy zsmoc1 zmme zca5a zigf2r zefna4 zmvk zcd4 zil10rb zpltp zdpy30 zcstb zproc ztimp1 zcdhr5 zpcsk9 zhao1 zlsp1 zifnlr1 zccl7 zigsf8  {
med4way zLE8_TOTALSCOREinv `m' AGE SEX NonWhite householdsize SES if sample_final==1 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
}
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\FIGURE4_PCA_MED4WAY.smcl",replace

use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\finaldata_unimputedfin",clear



**************************************************PRINCIPAL COMPONENTS ANALYSIS OF TOP 144 PROTEINS WITH 0.20 EFFECT SIZE WITH SEVERE LE8 TOTAL SCORE AND PASSED BONFERRONI CORRECTION, PLUS HAD A SIGNIFICANT TE and PIE AT TYPE I ERROR OF 0.05 (N=68)

** zvwa1  zprcp  zlpl zfurin  zgsta1  zplat ztfpi  zerbb2  zst6gal1  zigfbp2  zdcxr  zcpm  zcntn3 ztnfrsf1a  zcdhr2   zcd99l2  zgsta3   zitga5 zca14   zgdf15  zigsf3  zfstl3 zssc4d  zpts **zacy1  zrarres2   zlamp2 zcol6a3  zc19orf12 zadm  zldlr   zgusb  zinhbc  zf7   zces1 zoxt zpamr1  zcxcl17  zsord  zplaur zscly zadh4  zacvrl1 zkynu  zctsd  znomo1 zgfra1  zcrhbp  zcreg1
**ztnfrsf6b  zp4hb   zil13ra1  ztgfa  zmegf9 zil16 zaldh1a1  zpla2g10    zesm1  zslc39a5 znpy   zca5a  zmvk  zproc  zcdhr5 zhao1  zifnlr1 zccl7     




**corr zvwa1  zprcp  zlpl zfurin  zgsta1  zplat ztfpi  zerbb2  zst6gal1  zigfbp2  zdcxr  zcpm  zcntn3 ztnfrsf1a  zcdhr2   zcd99l2  zgsta3   zitga5 zca14   zgdf15  zigsf3  zfstl3 zssc4d  zpts **zacy1  zrarres2   zlamp2 zcol6a3  zc19orf12 zadm  zldlr   zgusb  zinhbc  zf7   zces1 zoxt zpamr1  zcxcl17  zsord  zplaur zscly zadh4  zacvrl1 zkynu  zctsd  znomo1 zgfra1  zcrhbp  zcreg1 **ztnfrsf6b  zp4hb   zil13ra1  ztgfa  zmegf9 zil16 zaldh1a1  zpla2g10    zesm1  zslc39a5 znpy   zca5a  zmvk  zproc  zcdhr5 zhao1  zifnlr1 zccl7  if sample_final==1
...
**pca  zvwa1  zprcp  zlpl zfurin  zgsta1  zplat ztfpi  zerbb2  zst6gal1  zigfbp2  zdcxr  zcpm  zcntn3 ztnfrsf1a  zcdhr2   zcd99l2  zgsta3   zitga5 zca14   zgdf15  zigsf3  zfstl3 zssc4d  zpts **zacy1  zrarres2   zlamp2 zcol6a3  zc19orf12 zadm  zldlr   zgusb  zinhbc  zf7   zces1 zoxt zpamr1  zcxcl17  zsord  zplaur zscly zadh4  zacvrl1 zkynu  zctsd  znomo1 zgfra1  zcrhbp  zcreg1 *****ztnfrsf6b  zp4hb   zil13ra1  ztgfa  zmegf9 zil16 zaldh1a1  zpla2g10    zesm1  zslc39a5 znpy   zca5a  zmvk  zproc  zcdhr5 zhao1  zifnlr1 zccl7 if sample_final==1, comp(14)
**rotate
**scree
**graph save "scree.gph", replace

**capture drop mediator*
**predict  mediator1-mediator14
...
**med4way zLE8_TOTALSCOREinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) 


**}


**same direction as total effect, N=11 of the 68 selected above: 
**ztnfrsf1a zca14 zgdf15 zfstl3  zcol6a3 zplaur  zadm zgfra1  zacvrl1  ztnfrsf6b ztgfa 



pca  ztnfrsf1a zca14 zgdf15 zfstl3  zcol6a3 zplaur  zadm zgfra1  zacvrl1  ztnfrsf6b ztgfa if sample_final==1


pca  ztnfrsf1a zca14 zgdf15 zfstl3  zcol6a3 zplaur  zadm zgfra1  zacvrl1  ztnfrsf6b ztgfa if sample_final==1, comp(2)
rotate
scree
graph save "scree.gph", replace
...
med4way zLE8_TOTALSCOREinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_LIFESTYLEinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_BIOLOGICALinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_TOTALSCOREinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & SEX==1 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_LIFESTYLEinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & SEX==1 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_BIOLOGICALinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & SEX==1, a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_TOTALSCOREinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & SEX==2 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_LIFESTYLEinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & SEX==2 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_BIOLOGICALinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & SEX==2, a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_TOTALSCOREinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & AD_PGStert==1 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_LIFESTYLEinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & AD_PGStert==1 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_BIOLOGICALinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & AD_PGStert==1, a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_TOTALSCOREinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & AD_PGStert==2 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_LIFESTYLEinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & AD_PGStert==2 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_BIOLOGICALinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & AD_PGStert==2, a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_TOTALSCOREinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & AD_PGStert==3 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_LIFESTYLEinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & AD_PGStert==3 , a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
med4way zLE8_BIOLOGICALinv mediator`x' AGE SEX NonWhite householdsize SES  if sample_final==1 & AD_PGStert==3, a0(0) a1(1) m(0) yreg(cox) mreg(linear) fulloutput
...
**Alphabetically ordered inconsistent mediators**
zacy1
zadh4
zaldh1a1
zc19orf12
...
**Alphabetically ordered consistent mediators
...
capture log close
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\HEATMAP_LE8COMPONENTS.smcl",replace
...
global tflist ""
global modseq=0
foreach Y of var zacvrl1 zadm zca14 zcol6a3 zfstl3 zgdf15 zgfra1 zplaur ztgfa ztnfrsf1a ztnfrsf6b  {
...
****ERRATUM FOR FIGURE 3: INCONSISTENT MEDIATOR CXCL17 not CXL17, DONE: ASK YI-HAN TO RE-DO FIGURE 3, INCONSISTENT MEDIATORS***

***********************INCONSISTENT MEDIATORS*********************************************
use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\finaldata_unimputedfin",clear

global tflist ""
global modseq=0
foreach Y of var zacy1 zadh4 zaldh1a1 zc19orf12 zca5a zccl7 zcd99l2 zcdhr2 zcdhr5 zces1 zcntn3 zcpm zcreg1 zcrhbp zctsd zcxcl17 zdcxr zerbb2 zesm1 zf7 zfurin zgsta1 zgsta3 zgusb zhao1 zifnlr1 zigfbp2 zigsf3 zil13ra1 zil16 zinhbc zitga5 zkynu zlamp2 zldlr zlpl zmegf9 zmvk znomo1 znpy zoxt zp4hb zpamr1 zpla2g10 zplat zprcp zproc zpts zrarres2 zscly zslc39a5 zsord zssc4d zst6gal1 ztfpi zvwa1   {
foreach X of var zLE8_TOTALSCOREinv zLE8_LIFESTYLEinv zLE8_BIOLOGICALinv zLnLE8_COMP1DIETinv zLnLE8_COMP2PAinv zLnLE8_COMP3NICOTINEinv zLnLE8_COMP4SLEEPinv zLnLE8_COMP5BMIinv zLnLE8_COMP6LIPIDSinv zLnLE8_COMP7GLUCinv zLnLE8_COMP8BPinv {
global modseq=$modseq+1
tempfile tf$modseq
parmby "regr `Y' `X' AGE SEX NonWhite householdsize SES   if sample_final==1 , beta", label command format(estimate min95 max95 %8.2f p %8.1e) idn($modseq) saving(`tf$modseq',replace) flist(tflist)
...
save zOutputdata_overall_C, replace

keep if parmseq==1
save zOutputdata_overall_Cparmseq1,replace


//Total population//

use zOutputdata_overall_Cparmseq1, clear
...
graph save "SMILEPLOT_PROTEOME_LE8_INCONSISTENT.gph",replace
...
*********CONSISTENT MEDIATORS***********************
use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\SYNTAX\zOutputdata_overall_Bparmseq1", clear
sort idnum

save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\SYNTAX\zOutputdata_overall_Bparmseq1SORT", replace 
...
**********************INCONSISTENT MEDIATORS*********************************************
use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\SYNTAX\zOutputdata_overall_Cparmseq1", clear
sort idnum

save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\SYNTAX\zOutputdata_overall_Cparmseq1SORT", replace 
...
forval i=1(1)11 {
	use zOutputdata_overall_Cparmseq1SORT, clear
	keep if parmnum==`i'
	save zOutputdata_overall_Cparmseq1SORT`i', replace
}
...
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT2\SENSITIVITY_ANALYSIS.smcl",replace
...
save "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\finaldata_unimputedFINAL_SENS",replace
...
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT2\FIGURES4.smcl",replace

use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\finaldata_unimputedFINAL_SENS",clear
...
foreach x1 of varlist AGE householdsize townsend LE8* SES   {
...
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT2\TABLES2.smcl",replace
...
stcox LE8_TOTALSCORE AGE SEX NonWhite householdsize SES  if sample_final2==1
...
capture log using "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\OUTPUT\SENSITIVITY.smcl",replace

use "E:\UK_BIOBANK_PROJECT\UKB_PAPER8D_LE8PROTDEM\DATA\finaldata_unimputedfin",clear

foreach x of varlist LE8* {
stcox `x' AGE SEX SES  NonWhite householdsize if sample_final==1	
}


foreach x of varlist LE8* {
stcox `x' AGE SEX SES  NonWhite householdsize if sample_final==1 & SEX==1	
}


foreach x of varlist LE8* {
stcox `x' AGE SEX SES  NonWhite householdsize if sample_final==1 & SEX==2	
}

foreach x of varlist LE8* {
reg mediator1 `x' AGE SEX SES  NonWhite householdsize if sample_final==1	
reg mediator2 `x' AGE SEX SES  NonWhite householdsize if sample_final==1
}
